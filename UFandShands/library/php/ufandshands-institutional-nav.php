 <nav id="institutional-nav" class="white palatino" role="navigation">
  <ul id="top" class="container">
      <li id="inst-home"><a href="https://ufhealth.org" rel="nofollow" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/inst-home.png" width="120" height="45" alt="UF Health Home"></a></li>
